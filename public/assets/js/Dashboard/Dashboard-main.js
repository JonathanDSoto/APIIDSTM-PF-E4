...
!(function () {
    ...
    const o = document.querySelector("#horizontalBarChart"),
        i = {
            ...
            dataLabels: {
                ...
                formatter: function (e, t) {
                    return i.labels[t.dataPointIndex];
                },
                offsetX: 0,
    ...
    null !== o && new ApexCharts(o, i).render();
    var n,
            ...
            columnDefs: [
                    ...
                    render: function (e, t, a, s) {
                        ...
                        return (
                            ...
                            '<div class="d-flex align-items-center"><span class="me-3">' +
                                l[r] +
                                '</span><div><a class="text-body text-truncate fw-medium mb-2 text-wrap" href="app-academy-course-details.html">' +
                                o +
                ...
                },
                {
                    ...
                    render: function (e, t, a, s) {
                        ...
                        return (
                            '<span class="h6 mb-0 text-nowrap">' +
                            (r +
                                "h " +
                                (Math.floor(e.asMinutes()) - 60 * r) +
                                "m") +
                            "</span>"
                        );
                    },
