    ...
    return (function () {
        ...
        return (
            (function () {
                ...
                function v(t, e) {
                    for (var i = 0; i < e.length; i++) {
                        ...
                        (a.enumerable = a.enumerable || !1),
                            ...
                            Object.defineProperty(t, g(a.key), a);
                    }
                }
                function g(t) {
                    var e = (function (t, e) {
                ...
                b = z.contains("layout-navbar-fixed")
                    ? "sticky"
                    : z.contains("layout-navbar-hidden")
                    ? "hidden"
                    : "static";
                var w =
                        document
                    ...
                    O = z.contains("layout-menu-offcanvas")
                        ? "static-offcanvas"
                        : z.contains("layout-menu-fixed")
                        ? "fixed"
                        : z.contains("layout-menu-fixed-offcanvas")
                        ? "fixed-offcanvas"
                        : "static",
                    E = (function () {
                        function t(e) {
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    (this.settings.availableContentLayouts =
                                        v || t.CONTENT),
                                    (this.settings.availableLayouts =
                                        E || t.LAYOUTS),
                                    ...
                                    var P =
                                        this.settings.controls.indexOf("style");
                                    -1 !== P &&
                            ...
                            (i = [
                                    ...
                                    value: function () {
                                        ...
                                        "" !== u
                                            ...
                                            (this.settings.stylesOpt =
                                                -1 !==
                                                this.settings.styles.indexOf(a)
                                                    ? a
                                                    : this.settings
                                                          .defaultStyle),
                                                ...
                                                ? window.matchMedia(
                                                    ...
                                                    : ((this.settings.style =
                                                      ...
                                                      (document.cookie =
                                                          "style=light"))
                                                : ((document.cookie =
                                                      "style=; expires=Thu, 01 Jan 2000 00:00:00 UTC; path=/;"),
                                                  (this.settings.style =
                                                      -1 !==
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        ...
                                        var u = this.container.querySelector(
                                            ...
                                            d = u.querySelector(
                                                ".template-customizer-styles-options"
                                            );
                                        if (this._hasControls("style")) {
                                            this.settings.availableStyles.forEach(
                                                function (t) {
                                                    var e = i(
                                                        t.name,
                                                        t.title,
                                        ...
                                        if (
                                            ...
                                            if (
                                                ...
                                                this.settings.availableLayouts.forEach(
                                                    function (t) {
                                                        var e = i(
                                                            t.name,
                                                            t.title,
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        ...
                                        setTimeout(function () {
                                            var i = t.container.querySelector(
